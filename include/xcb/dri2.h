...
/**
 * @brief xcb_dri2_dri_2_buffer_t
 **/
typedef struct xcb_dri2_dri_2_buffer_t {
    uint32_t attachment; /**<  */
    uint32_t name; /**<  */
    uint32_t pitch; /**<  */
    uint32_t cpp; /**<  */
    uint32_t flags; /**<  */
} xcb_dri2_dri_2_buffer_t;

/**
 * @brief xcb_dri2_dri_2_buffer_iterator_t
 **/
typedef struct xcb_dri2_dri_2_buffer_iterator_t {
    xcb_dri2_dri_2_buffer_t *data; /**<  */
    int                      rem; /**<  */
    int                      index; /**<  */
} xcb_dri2_dri_2_buffer_iterator_t;
 ...
 * @param i Pointer to a xcb_dri2_dri_2_buffer_iterator_t
 *
 * Get the next element in the iterator. The member rem is
 * decreased by one. The member data points to the next
 * element. The member index is increased by sizeof(xcb_dri2_dri_2_buffer_t)
 */

/*****************************************************************************
 **
 ** void xcb_dri2_dri_2_buffer_next
 ** 
 ** @param xcb_dri2_dri_2_buffer_iterator_t *i
 ** @returns void
 **
 *****************************************************************************/
 
void
xcb_dri2_dri_2_buffer_next (xcb_dri2_dri_2_buffer_iterator_t *i  /**< */);

/**
 * Return the iterator pointing to the last element
 * @param i An xcb_dri2_dri_2_buffer_iterator_t
 * @return  The iterator pointing to the last element
 *
...
/*****************************************************************************
 **
 ** xcb_generic_iterator_t xcb_dri2_dri_2_buffer_end
 ** 
 ** @param xcb_dri2_dri_2_buffer_iterator_t i
...
xcb_dri2_dri_2_buffer_end (xcb_dri2_dri_2_buffer_iterator_t i  /**< */);
...
/*****************************************************************************
 **
 ** xcb_dri2_dri_2_buffer_t * xcb_dri2_get_buffers_buffers
 ** 
 ** @param const xcb_dri2_get_buffers_reply_t *R
 ** @returns xcb_dri2_dri_2_buffer_t *
 **
 *****************************************************************************/
...
/*****************************************************************************
 **
 ** xcb_dri2_dri_2_buffer_iterator_t xcb_dri2_get_buffers_buffers_iterator
 ** 
 ** @param const xcb_dri2_get_buffers_reply_t *R
 ** @returns xcb_dri2_dri_2_buffer_iterator_t
 **
 *****************************************************************************/
...
/*****************************************************************************
 **
 ** xcb_dri2_dri_2_buffer_t * xcb_dri2_get_buffers_with_format_buffers
 ** 
...
/*****************************************************************************
 **
 ** xcb_dri2_dri_2_buffer_iterator_t xcb_dri2_get_buffers_with_format_buffers_iterator
 ** 
 ** @param const xcb_dri2_get_buffers_with_format_reply_t *R
 ** @returns xcb_dri2_dri_2_buffer_iterator_t
 **
